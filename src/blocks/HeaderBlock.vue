    ...
    <header>
        <div class="bg">
            <div class="sun-container">
                <div class="sun">
                    <div class="sun-aura" id="aura01"></div>
                    <div class="sun-aura" id="aura02"></div>
