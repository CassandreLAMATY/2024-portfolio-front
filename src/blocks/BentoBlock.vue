...
<template>
    <section class="bento-container">
        <div>
            <div class="welcome">
                <h3 class="welcome-overline">Welcome to my</h3>
                <div class="welcome-title--container">
                    <h2 class="welcome-title">Portfolio</h2>
                    <font-awesome-icon :icon="['fas', 'sparkle']" id="spark01" />
                    <font-awesome-icon :icon="['fas', 'sparkle']" id="spark02" />
                    <font-awesome-icon :icon="['fas', 'sparkle']" id="spark03" />
                </div>
            ...
            <div class="bento">
                ...
                <div class="bento-grid">
                    ...
                    <routerLink to="/development" id="dev">
                        <div class="bento-card">
                            <div class="bento-card--bg">
                                <p>
                                    ...
                                    MoO MoO MoO MoO MoO MoO MoO MoO MoO Moo MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO
                                    MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO Moo MoO MoO
                                    MoO MoO MoO MoO MoO Moo Moo MoO MoO MoO Moo OOO MoO MoO MoO MoO MoO MoO MoO MoO MoO
                                    MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO
                                    MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO Moo MoO MoO MoO MoO MoO MoO
                                    MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO
                                    MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO
                                    ...
                                    MOo MOo MOo MOo MOo MOo MOo MOo MOo MOo MOo MOo MOo MOo MOo MOo MOo MOo MOo MOo MOo
                                    MOo MOo MOo MOo MOo Moo MOo MOo MOo MOo MOo MOo MOo MOo Moo MoO MoO MoO Moo MOo MOo
                                    MOo MOo MOo MOo Moo MOo MOo MOo MOo MOo MOo MOo MOo Moo OOO MoO MoO MoO MoO MoO MoO
                                    MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO MoO Mo
                                </p>
                            </div>
                            <div class="bento-title--container">
                                <h2>Development</h2>
...
<style>
@import url('@/assets/stylesheets/css/bento.css');
</style>
